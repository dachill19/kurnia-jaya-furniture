...
const AddProductPage = () => {
  ...
  const { categories, getCategories, error: productError } = useProductStore();
  const { createProduct, error: adminError, clearError } = useAdminProductStore();
  ...
  return (
    <div className="container-custom py-8">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h2 className="text-2xl sm:text-3xl font-serif font-bold text-gray-800">Tambah Produk</h2>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end gap-3 pt-4">
              ...
              <Button
                ...
                disabled={isLoadingKey("create-product")}
              >
                {isLoadingKey("create-product") ? "Menyimpan..." : "Simpan Produk"}
              </Button>
            </div>
          </form>
        </CardContent>
